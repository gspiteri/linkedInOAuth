...
public class oAuthLinkedIn : oAuthBase2
    {
        ...
        public const string REQUEST_TOKEN = "https://api.xero.com/oauth/RequestToken";
        public const string AUTHORIZE = "https://api.xero.com/oauth/Authorize";
        public const string ACCESS_TOKEN = "https://api.xero.com/oauth/AccessToken";
...
#region Properties
        ...
        public string APIWebRequest(string method, string url, string postData)
        {
            ...
            webRequest.Headers.Add("Authorization", "OAuth realm=\"https://api.xero.com/\",oauth_consumer_key=\"" + this.ConsumerKey + "\",oauth_token=\"" + this.Token + "\",oauth_signature_method=\"HMAC-SHA1\",oauth_signature=\"" + HttpUtility.UrlEncode(sig) + "\",oauth_timestamp=\"" + timeStamp + "\",oauth_nonce=\"" + nonce + "\",oauth_verifier=\"" + this.Verifier + "\", oauth_version=\"1.0\"");
